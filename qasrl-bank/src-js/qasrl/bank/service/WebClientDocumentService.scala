...
// case class WebClientDocumentServiceInterpreter(
//   apiUrl: String,
//   alreadyLoadedIndex: Option[DataIndex] = None
// ) extends (DocumentService.RequestA ~> Future) {
//   import DocumentService._
...
//   private[this] var indexCache: Option[DataIndex] = alreadyLoadedIndex
//   private[this] val documentCache = mutable.Map.empty[DocumentId, Document]
...
//   alreadyLoadedIndex: Option[DataIndex] = None
// ) extends InterpretedDocumentService[CacheCall](
//   WebClientDocumentServiceInterpreter(apiUrl, alreadyLoadedIndex)
// )
